...
Smooth Animations: Fade-in effects and hover interactions for an engaging UI.
Skills Showcase: Interactive skill badges with hover effects.
Resume Download: Access my resume directly from the homepage.
...
Replace placeholder images (e.g., https://via.placeholder.com/) with your own.
